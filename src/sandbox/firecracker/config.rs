...
pub struct FirecrackerCommonConfig {
    ...
    /// One-time hostname for a new instance; resumes preserve the captured guest state.
    #[serde(skip)]
...
impl FirecrackerCommonConfig {
    pub fn new(
        ...
        Self {
            ...
            hostname: Some("taskenv".to_owned()),
...
impl FirecrackerSandboxConfig {
    ...
    pub fn apply_launch_config(mut self, launch_config: &SandboxLaunchConfig) -> Self {
        self.common.hostname = Some(launch_config.hostname.clone());
